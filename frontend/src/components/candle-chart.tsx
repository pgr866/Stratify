...
import { createChart, TimeChartOptions, DeepPartial } from 'lightweight-charts';

export function CandleChart() {
    useEffect(() => {
        const chartContainer = document.getElementById('chart-container')!;
        const chartOptions: DeepPartial<TimeChartOptions> = { layout: { textColor: 'white', background: { color: 'black' } } };
