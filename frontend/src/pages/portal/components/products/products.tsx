    ...
    <ResizablePanelGroup direction="vertical" className="size-full rounded-lg border">
      <ResizablePanel defaultSize={50}>
        <div className="flex flex-wrap items-center text-sm p-1">
          <Combobox values={strategies} variant={"ghost"} size={"sm"} width={"160px"} placeholder={"Strategy"} />
          <Separator orientation="vertical" className="h-5 mx-1" />
          <Combobox values={exchanges} variant={"ghost"} size={"sm"} width={"160px"} placeholder={"Exchange"} />
          <Separator orientation="vertical" className="h-5 mx-1" />
          <Combobox values={symbols} variant={"ghost"} size={"sm"} width={"160px"} placeholder={"Symbol"} />
          <Separator orientation="vertical" className="h-5 mx-1" />
          <Select>
            <SelectTrigger
          ...
          <Separator orientation="vertical" className="h-5 mx-1" />
          <Combobox values={symbols} variant={"ghost"} size={"sm"} width={"160px"} placeholder={"Indicators"} />
          <Separator orientation="vertical" className="h-5 mx-1" />
          <Button variant={"ghost"} size={"sm"} className="w-[165px] overflow-hidden font-normal">
